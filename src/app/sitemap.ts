...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: "https://yaa.com.ar/registro", lastModified, changeFrequency: "weekly", priority: 0.9 },
    { url: "https://yaa.com.ar/demo", lastModified, changeFrequency: "weekly", priority: 0.8 },
