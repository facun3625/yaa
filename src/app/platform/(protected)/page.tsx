...
import { ArrowRightIcon, StoreIcon, WalletIcon, ClockIcon, ShoppingBagIcon, AlertTriangleIcon, BanIcon } from "lucide-react";
...
export default async function PlatformDashboard() {
  ...
  const kpis = [
    ...
    { label: "Facturación mensual (MRR)", value: formatPrice(stats.mrr), icon: WalletIcon },
    { label: "Pedidos (30 días)", value: stats.ordersLast30Days, icon: ShoppingBagIcon },
